        ...
        <div class="flex flex-col md:flex-row w-full h-full">
            ...
            <div class="w-full md:w-3/5 hidden md:flex items-center justify-center">
                <div class="text-center">
                    <img src="<?= BASEURL; ?>/img/auth/image.png" alt="Illustration of two people sitting at a table, drinking coffee and talking" class="w-full h-auto" width="626" height="626" />
                </div>
            </div>
            <!-- Right Side -->
            <div class="w-full md:w-2/5 flex flex-col justify-center px-4 md:px-8 max-w-md mx-auto">
                <div class="mb-4 flex items-center">
                    <img src="<?= BASEURL; ?>/img/auth/logo.png" alt="Bonanza Logo" width="50" height="50" />
                ...
                <form id="login-form" action="<?= BASEURL; ?>/auth/btnLoginAdmin" method="POST" class="flex flex-col items-center">
                    <div class="mb-4 w-full">
                        <label class="block text-gray-700" for="email">Email</label>
                        <div class="flex items-center border border-gray-300 rounded-md p-2 w-full">
                            <i class="fas fa-envelope text-gray-400 mr-2"></i>
                            <input type="email" name="email" id="email" placeholder="Email" value="<?= isset($_SESSION['login_data']['email']) ? htmlspecialchars($_SESSION['login_data']['email']) : ''; ?>" class="w-full outline-none text-base" required aria-label="Email" />
                        </div>
                    </div>
                    <div class="mb-4 w-full relative">
                        ...
                        <div class="flex items-center border border-gray-300 rounded-md p-2 w-full">
                            ...
                            <input type="password" name="password" id="password" placeholder="Password" class="w-full outline-none text-base" required aria-label="Password" />
        ...
        window.onload = function() {
            ...
            if (notification) {
                setTimeout(() => {
                    ...
                    window.location.href = "<?= BASEURL; ?>/admin/dashboard"; // Change to the target page after success
                }, 3000); // 3 seconds
            }
        };

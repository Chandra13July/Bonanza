        ...
        <div class="flex flex-col md:flex-row w-full h-full">
            ...
            <div class="w-full md:w-3/5 hidden md:flex items-center justify-center">
                <div class="text-center">
                    <img src="<?= BASEURL; ?>/img/auth/image.png" alt="Illustration of two people sitting at a table, drinking coffee and talking" class="w-5/5 h-auto" width="626" height="626" />
                </div>
            </div>
            <!-- Right Side -->
            <div class="w-full md:w-2/5 flex flex-col justify-center px-4 md:px-8 max-w-md mx-auto">
                ...
                <form id="signup-form" action="<?= BASEURL; ?>/auth/btnSignupAdmin" method="POST" class="flex flex-col items-center">
                ...
                <div class="text-center mt-6">
                    <p class="text-gray-500">Already have an account? <a href="<?= BASEURL; ?>/auth/loginAdmin" class="text-blue-500 hover:underline">Login</a></p>
                </div>
            </div>
        </div>
    </div>
        ...
        window.onload = function() {
            ...
            if (notification) {
                setTimeout(() => {
                    ...
                    window.location.href = "<?= BASEURL; ?>/auth/loginAdmin"; // Redirect to the login page

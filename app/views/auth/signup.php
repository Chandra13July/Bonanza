...
<body class="bg-white flex items-center justify-center h-screen">
    ...
    <script>
        // Menyembunyikan notifikasi berhasil setelah beberapa detik dan mengalihkan ke halaman login
        window.onload = function() {
            const notification = document.getElementById('success-notification');
            if (notification) {
                setTimeout(() => {
                    notification.classList.add('hidden');
                    window.location.href = "<?= BASEURL; ?>/auth/login"; // Mengarahkan ke halaman login

  ...
  <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-10 lg:py-20 px-10 lg:px-20">
    <div class="w-full lg:w-1/2 lg:pr-10 mb-10 lg:mb-0" data-sr-id="1">
      ...
      <div class="flex space-x-4">
        ...
        <button class="border border-black text-black py-2 px-6 rounded-full">
          Explore Menu
        </button>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div class="bg-white p-6 rounded-lg shadow-lg" data-sr-id="9">
        ...
        <p class="text-gray-600">
          "Bonanza Cafe offers the best coffee experience. The atmosphere is cozy and the staff are friendly. Highly recommended!"
        </p>
      </div>
      <div class="bg-white p-6 rounded-lg shadow-lg" data-sr-id="10">
        ...
        <p class="text-gray-600">
          "I love the unique industrial design of Bonanza Cafe. The coffee is top-notch and the food is delicious. A must-visit!"
        </p>
      </div>
      <div class="bg-white p-6 rounded-lg shadow-lg" data-sr-id="11">
        ...
        <p class="text-gray-600">
          "Bonanza Cafe is my go-to place for meetings and relaxation. The ambiance is perfect and the service is excellent."
        </p>
      </div>
    </div>
  </div>

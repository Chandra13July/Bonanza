...
<head>
    ...
    <title>Rumah Kami Bonanza</title>
...
<section class="py-8 px-4 md:px-0">
    <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
        ...
        <div class="w-full md:w-1/2 text-left md:pl-12 mt-4 md:mt-0">
            <h1 class="text-4xl md:text-6xl font-bold">RUMAH KAMI BONANZA</h1>
            <p class="mt-2 md:mt-4 text-base md:text-lg">Bonanza adalah rumah bagi siapa saja yang ingin beristirahat. Datanglah ke sini kapan saja jika merasa lelah.</p>
...
<div class="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 mt-4 px-4 md:px-0">
    <div class="text-left">
        <img alt="Kopi pagi" class="mx-auto" height="500" src="<?= BASEURL; ?>/img/home/image (1).png" width="300"/>
    ...
    <div class="text-left">
        <img alt="Kopi dengan nuansa alam" class="mx-auto" height="500" src="<?= BASEURL; ?>/img/home/image.png" width="300"/>
    ...
    <div class="text-left hidden md:block">
        <img alt="Kopi untuk bekerja" class="mx-auto" height="500" src="<?= BASEURL; ?>/img/home/image (2).png" width="300"/>
        <p class="mt-2 text-sm font-thin text-left" style="width: 300px;">KOPI UNTUK BEKERJA</p>
        <p class="text-left text-xs" style="width: 300px;">2024</p>
    </div>
    <div class="text-left hidden md:block">
        <img alt="Kopi manis untuk hari Anda" class="mx-auto" height="500" src="<?= BASEURL; ?>/img/home/image (3).png" width="300"/>
...
<section class="bg-gray-200 py-12 text-center mt-8 px-4 md:px-0">
    ...
    <button class="px-6 py-2 bg-black text-white font-bold">PESAN SEKARANG</button>
</section>    
...
<section class="py-12 px-4 md:px-0">
    <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <button class="px-6 py-2 bg-black text-white font-bold">LIHAT SELENGKAPNYA</button>
        </div>
    </div>
</section>
...
<section class="py-12 text-center px-4 md:px-0">
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div>
            <img alt="Interior kafe dengan desain modern" src="https://storage.googleapis.com/a1aa/image/egw1dIWfRbluY0QIFAqR3dXjCQOGHOKqQxB4IGjNdwWr3otTA.jpg" width="400" height="600" class="w-full h-[600px] object-cover"/>
        </div>
        <div>
            <img alt="Interior kafe dengan desain modern" src="https://storage.googleapis.com/a1aa/image/egw1dIWfRbluY0QIFAqR3dXjCQOGHOKqQxB4IGjNdwWr3otTA.jpg" width="400" height="600" class="w-full h-[600px] object-cover"/>
        </div>
